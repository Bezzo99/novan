...
const proxyListURL = 'https://novan.life/update_proxyip.txt';
const pagehost = '/'
const namaWeb = 'NOVAN TUNNEL'
const telegramku = 'https://t.me/novanthekillz'
const telegrambot = 'https://t.me/xnxx_bot'
const waku = 'https://wa.me/6287836267414'
const waku1 = 'https://wa.me/6281324535082'
const wildcards = [
  'ava.game.naver.com',
  'business.blibli.com',
   'graph.instagram.com',
...
export default {
  async fetch(request, env, ctx) {
    try {
      ...
      const CHECK_API_BASE = "https://api.novan.life"; // Get base URL from secrets
...
@keyframes spinColors {
  ...
  animation: spin 1s linear infinite;
      ...
      * {
      ...
      body {
  background: url('https://novan.life/Gmbr/1718980064522.jpg') no-repeat center center fixed;
